...
class UsuarioTest {
	...
	@Test
	void testExibeItem() {
		Usuario u = new Usuario("167", "Joao Victor", "joao.wanderley@ccc.ufcg.edu.br", "9999-8321", "doador", "PESSOA_FISICA");
	...
	void testAdicionaItem() {
		Usuario u = new Usuario("999", "Lucas Leal", "lucas.lucena@ccc.ufcg.edu.br", "2345-6780", "doador", "PESSOA_FISICA");
	...
	void testGetItens() {
		...
		assertEquals(u.getItens(), "{1=1 - alfinete, tags: [prata], quantidade: 10, 2=2 - bola de volei, tags: [bola branca], quantidade: 2, 3=3 - bola de volei, tags: [bola azul], quantidade: 1}");
	}
	
	@Test
	void testSetNome() {
		Usuario u = new Usuario("167", "Joao Vcitor", "joao.wanderley@ccc.ufcg.edu.br", "9999-8321", "doador", "PESSOA_FISICA");
